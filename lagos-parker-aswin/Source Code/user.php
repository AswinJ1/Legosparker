 ...
 $sql = "SELECT * FROM tbl_user WHERE email='" .$unm . "' and password = '". $pass."'";
  ...
  <div class="popup__content">
    ...
    <p>
     ...
     <?php echo "<script>setTimeout(\"location.href = 'index-user.php';\",1500);</script>"; ?>
    </p>
  </div>
</div>
   <!--   <script>
...
NEW USER PLEASE <a href="user-signup.php">CLICK HERE</a> TO PROCEED
</div>
...
</div><a href="index-main.php">Back to Home</a><br><br><br><br><br><br>
