...
<body>
    ...
    <div id="index-main.php" class="header_section">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="logo"><a href="index-main.php"><img src="images/logo.png"></a></div>
                </div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <div class="row">
          <div class="col-md-6">
            <div class="book_now">
              <h1 class="book_text">LAGOS PARKER</h1>
    ...
    <div class="carousel-item">
      <div class="row">
          <div class="col-md-6">
            <div class="book_now">
              <h1 class="book_text">BOOK NOW</h1><a  href="user-signup.php" ></a>
  ...
  <a class="carousel-control-next" href="#main_slider" role="button" data-slide="next">
    ...
    <div id="taxis" class="taxis_section layout_padding">
      <div class="container">
        <h1 class="our_text">LAGOS<span style="color: #f4db31;">PARKER</span></h1>
        <div class="taxis_section_2">
          <div class="row">
            <div class="col-sm-4">
              <div class="taxi_main">
                <div class="round_1"></div>
                <h2 class="carol_text"></h2>
                <p class="reader_text"></p>
    ...
    <div id="booking" class="ride_section layout_padding">
      <div class="container">
        <div class="ride_main">
          <h1 class="ride_text">Why <span style="color: #f4db31;">LAGOS PARKER</span></h1>
      </div>
        </div>
    </div>
    <div class="ride_section_2 layout_padding">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-8">
            <h1 class="cabe_text">LAGOS for Every Pocket</h1>
            ...
            <div class="book_bt"><a href="user-signup.php">BOOK NOW</a></div>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-sm-8">
            ...
            <div class="book_bt_2"><a href="user-signup.php">BOOK NOW</a></div>
          </div>
          <div class="col-sm-4">
          ...
          <div class="footer_section_2">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                  ...
                  <div class="image-icon"><img src="images/bulit-icon.png"><span class="fb_text"><a href="login.php">admin</span></a></div>
                <div class="image-icon"><img src="images/bulit-icon.png"><span class="fb_text"><a href="user-signup.php">user</span></a></div>
